...
(function(factory) { if (typeof define === "function" && define.amd) { define(["./inputmask"], factory) } else if (typeof exports === "object") { module.exports = factory(require("./inputmask")) } else { factory(window.Inputmask) } })(function(Inputmask) {
    ...
    function analyseMask(maskString, format, opts) {
        ...
        if (typeof mask === "string") {
            ...
            return dateObj
        } else if (mask && typeof mask === "object" && mask.hasOwnProperty("date")) { return mask }
        return undefined
    }
    Inputmask.extendAliases({
        datetime: {
            ...
            min: null,
            max: null,
            i18n: { dayNames: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], monthNames: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Janeiro", "Fevereiro", "Maio", "Abril", "May", "Junho", "Julho", "Agosto", "Setembro", "October", "Novembro", "Dezembro"], ordinalSuffix: ["st", "nd", "rd", "th"] },
            ...
            onUnMask: function(maskedValue, unmaskedValue, opts) { return parse(opts.outputFormat, analyseMask(maskedValue, opts.inputFormat, opts), opts, true) },
            casing: function(elem, test, pos, validPositions) { if (test.nativeDef.indexOf("[ap]") == 0) return elem.toLowerCase(); if (test.nativeDef.indexOf("[AP]") == 0) return elem.toUpperCase(); return elem },
            insertMode: false,
